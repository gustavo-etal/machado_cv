...
Publication: 162; Total Citations: 2589 (Google Scholar); h-index: 27 (Google Scholar); * Denotes Student or Researcher Advisee
...
\Year{2023}  &
\Me\ How on-farm biosecurity, pig and vehicle movement may explain between-farm disease dissemination?,
  \emph{COST (European Cooperation in Science and Technology) BETTER webinar},
  Online.
  \\

\Year{2023}  &
\Me\ Data and analytics to prevent between-farm disease spread,
