...
\begin{EntriesTable}
\Year{2021}  &
  Cardenas, N.C., Sykes, A.L., Lopes, F.P.N., {\textbf{Machado, Gustavo.}}\
  Multiplespecies animal movements: network properties, disease dynamic and the impact of targeted control actions.
  %\emph{arXiv}.
  \Preprint{}\href{https://arxiv.org/abs/2107.10108}{Link}
  %\GitHub{}
  \\

\Year{2021}  &
  Galvis, J.A., Corzo, C., \Me.\
  Modelling porcine reproductive and respiratory syndrome virus dynamics to quantify the contribution of multiple modes of transmission: between-farm animal and vehicle movements, farm-to-farm proximity, feed ingredients, and re-break. \Preprint{}\href{https://www.biorxiv.org/content/10.1101/2021.07.26.453902v3}{Link}
  %\GitHub{}
    \\
 ...
 \Year{2021}  &
  Gumanga, G., \Me\, et al.
  Spatiotemporal dynamics of foot and mouth disease outbreaks in India, 2008-2016. \Preprint{}\href{https://www.authorea.com/doi/full/10.22541/au.162314532.27755027}{Link}
  %\GitHub{}
...
- Current states utilizing RABapp: In total 10 State Animal Health Official (SAHO) are currently using the RABapp or at final arrangements/agreements to utilize the
\href{https://machado-lab.github.io/rabapp/}{RABapp}. The RABApp is technology is licensing under NCSU software innovation number (2021-137).
